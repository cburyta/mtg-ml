...
def test_preprocessed_card_text_is_separated_into_actions_and_casting_costs:
    ...
    assert separated[1][0] == "-3"
    assert separated[1][1] == "You may put a green creature card from your hand onto the battlefield."
    assert separated[2][0] == "-7"
    assert separated[2][1] == "You get an emblem with \"\"Swamps you control have '{T}: Add {B}{B}{B}{B}.'\"\""
